import"./supabase-ZrA-IRof.js";import{I as e,h as t}from"./user-BawuWBq3.js";import{t as n}from"./pagination-DVzefm8X.js";var{supabase:r,keysToSnakeDeep:i,responseHandle:a}=e(),o=500;new t({idKey:`id`,parentKey:`parentId`,childrenKey:`children`});async function s(){return await n(({from:e,to:t})=>{let n=r.from(`sys_dictionary`).select(`
          id,
          type_id,
          code,
          label,
